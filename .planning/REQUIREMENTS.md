...
- [ ] **VAL-01**: Zod schemas defined for all server action inputs (items, contacts, borrow, groups, users, auth, notifications)
- [ ] **VAL-02**: next-safe-action client configured with auth middleware pattern
